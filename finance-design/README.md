...
Its breakdown for months before September is estimated.
...
| Category history | `CategoryDetail.dc.html` | One category's total for each of the last 6 months as bars (tap a month), change from the previous month and from the 6-month average, the category's budget, and its subcategories with share and amount |
